<%@ Page Language="C#" MasterPageFile="~/Homemas1.master" AutoEventWireup="true" CodeFile="serverlogin.aspx.cs" Inherits="serverlogin" Title="Untitled Page" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div align=center>
    <asp:Label ID="Label1" runat="server" Text="server Login" Font-Bold="True"></asp:Label>
    <br />
    <tr align=center>
    <td>
